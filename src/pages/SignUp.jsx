...
const SignUpPage = () => {
  ...
  const validate = () => {
    ...
    if (!/^[\d\s]+$/.test(formData.phoneNumber.trim())) newErrors.phoneNumber = 'Invalid phone number format';
  ...
  return (
    <div className="signup-page container mx-auto my-10 px-4">
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 mb-2" htmlFor="image">Upload Face Image (optional)</label>
          <input
            type="file"
            id="image"
            name="image"
        ...
        <div className="mb-4">
          ...
          {isCameraOpen && (
            <div>
              <video ref={videoRef} width="640" height="480" autoPlay className="mt-4 mx-auto"></video>
